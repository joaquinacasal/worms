...
CxxTest::StaticSuiteDescription suiteDescription_BeamTest( "MyTestSuite.h", 176, "BeamTest", suite_BeamTest, Tests_BeamTest );

static class TestDescription_suite_BeamTest_testConstructorDeLaViga : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_BeamTest_testConstructorDeLaViga() : CxxTest::RealTestDescription( Tests_BeamTest, suiteDescription_BeamTest, 188, "testConstructorDeLaViga" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_TurnsManagerTest( "MyTestSuite.h", 218, "TurnsManagerTest", suite_TurnsManagerTest, Tests_TurnsManagerTest );

static class TestDescription_suite_TurnsManagerTest_testManejadorDeTurnos : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_TurnsManagerTest_testManejadorDeTurnos() : CxxTest::RealTestDescription( Tests_TurnsManagerTest, suiteDescription_TurnsManagerTest, 227, "testManejadorDeTurnos" ) {}
...
public:
 TestDescription_suite_TurnsManagerTest_testCambioDeTurnosConGusanos() : CxxTest::RealTestDescription( Tests_TurnsManagerTest, suiteDescription_TurnsManagerTest, 263, "testCambioDeTurnosConGusanos" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_TeletransportationTest( "MyTestSuite.h", 296, "TeletransportationTest", suite_TeletransportationTest, Tests_TeletransportationTest );
...
public:
 TestDescription_suite_TeletransportationTest_testTeletransportacionUnSoloGusano() : CxxTest::RealTestDescription( Tests_TeletransportationTest, suiteDescription_TeletransportationTest, 306, "testTeletransportacionUnSoloGusano" ) {}
...
public:
 TestDescription_suite_TeletransportationTest_testTeletransportacionMuchosGusanos() : CxxTest::RealTestDescription( Tests_TeletransportationTest, suiteDescription_TeletransportationTest, 358, "testTeletransportacionMuchosGusanos" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_DynamiteTest( "MyTestSuite.h", 531, "DynamiteTest", suite_DynamiteTest, Tests_DynamiteTest );

static class TestDescription_suite_DynamiteTest_testExplosionDinamita : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_DynamiteTest_testExplosionDinamita() : CxxTest::RealTestDescription( Tests_DynamiteTest, suiteDescription_DynamiteTest, 540, "testExplosionDinamita" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_RadiocontrolledTest( "MyTestSuite.h", 591, "RadiocontrolledTest", suite_RadiocontrolledTest, Tests_RadiocontrolledTest );

static class TestDescription_suite_RadiocontrolledTest_testCaidaRadiocontrolled : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_RadiocontrolledTest_testCaidaRadiocontrolled() : CxxTest::RealTestDescription( Tests_RadiocontrolledTest, suiteDescription_RadiocontrolledTest, 600, "testCaidaRadiocontrolled" ) {}
