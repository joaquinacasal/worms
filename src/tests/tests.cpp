...
CxxTest::StaticSuiteDescription suiteDescription_BeamTest( "MyTestSuite.h", 159, "BeamTest", suite_BeamTest, Tests_BeamTest );

static class TestDescription_suite_BeamTest_testConstructorDeLaViga : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_BeamTest_testConstructorDeLaViga() : CxxTest::RealTestDescription( Tests_BeamTest, suiteDescription_BeamTest, 171, "testConstructorDeLaViga" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_TurnsManagerTest( "MyTestSuite.h", 201, "TurnsManagerTest", suite_TurnsManagerTest, Tests_TurnsManagerTest );

static class TestDescription_suite_TurnsManagerTest_testManejadorDeTurnos : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_TurnsManagerTest_testManejadorDeTurnos() : CxxTest::RealTestDescription( Tests_TurnsManagerTest, suiteDescription_TurnsManagerTest, 210, "testManejadorDeTurnos" ) {}
...
public:
 TestDescription_suite_TurnsManagerTest_testCambioDeTurnosConGusanos() : CxxTest::RealTestDescription( Tests_TurnsManagerTest, suiteDescription_TurnsManagerTest, 246, "testCambioDeTurnosConGusanos" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_TeletransportationTest( "MyTestSuite.h", 279, "TeletransportationTest", suite_TeletransportationTest, Tests_TeletransportationTest );
...
public:
 TestDescription_suite_TeletransportationTest_testTeletransportacionUnSoloGusano() : CxxTest::RealTestDescription( Tests_TeletransportationTest, suiteDescription_TeletransportationTest, 289, "testTeletransportacionUnSoloGusano" ) {}
...
public:
 TestDescription_suite_TeletransportationTest_testTeletransportacionMuchosGusanos() : CxxTest::RealTestDescription( Tests_TeletransportationTest, suiteDescription_TeletransportationTest, 341, "testTeletransportacionMuchosGusanos" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_DynamiteTest( "MyTestSuite.h", 514, "DynamiteTest", suite_DynamiteTest, Tests_DynamiteTest );

static class TestDescription_suite_DynamiteTest_testExplosionDinamita : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_DynamiteTest_testExplosionDinamita() : CxxTest::RealTestDescription( Tests_DynamiteTest, suiteDescription_DynamiteTest, 523, "testExplosionDinamita" ) {}
...
CxxTest::StaticSuiteDescription suiteDescription_RadiocontrolledTest( "MyTestSuite.h", 574, "RadiocontrolledTest", suite_RadiocontrolledTest, Tests_RadiocontrolledTest );

static class TestDescription_suite_RadiocontrolledTest_testCaidaRadiocontrolled : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_RadiocontrolledTest_testCaidaRadiocontrolled() : CxxTest::RealTestDescription( Tests_RadiocontrolledTest, suiteDescription_RadiocontrolledTest, 583, "testCaidaRadiocontrolled" ) {}
